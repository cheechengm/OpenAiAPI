...
// Modify fetch requests to use absolute URLs
const metaUrl = `${baseUrl}/openai/meta`;
const imageUrl = `${baseUrl}/openai/image`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    metaForm.addEventListener('submit', async (e) => {
        ...
        const res = await fetch(metaUrl, { // Use absolute URL
    ...
    imageForm.addEventListener('submit', async (e) => {
        ...
        const res = await fetch(imageUrl, { // Use absolute URL
            headers: { 'Content-Type': 'application/json' },
